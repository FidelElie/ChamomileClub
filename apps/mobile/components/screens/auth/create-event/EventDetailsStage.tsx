import { DateTimeField, Flex, Heading, Show, TextField } from "@thechamomileclub/ui";
...
export const EventDetailsStage = (props: CreateEventsInterface) => {
	...
	return (
		<Flex.Column>
			<Show if={isFounder}>
				<Heading className="mb-5 mt-3" size="base">What is it about?</Heading>
				<TextField
			...
			<Heading className="mb-3 mt-5" size="base">When will it happen?</Heading>
			<DateTimeField
				theme="TERTIARY"
				// value={new Date()}
			/>

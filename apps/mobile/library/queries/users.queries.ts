...
export const useCreateUsers = () => useMutation(
	async (context: InferDTOs<typeof CreateUsersInterfaces>) => {
		const { body } = context;
...
export const useEditUser = () => useMutation(
	async (context: InferDTOs<typeof EditUserInterfaces>) => {
		const { params: { userId }, body } = context;
...
export const useDeleteUser = () => useMutation(
	async (context: InferDTOs<typeof DeleteUserInterfaces>) => {

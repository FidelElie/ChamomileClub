...
import { Heading, TextField, Flex, Button, Copy, COLORS, Show } from "@thechamomileclub/ui";
		...
		>
			<ScrollView className="flex-grow">
				<Flex.Row className="bg-midnight px-6 py-4 rounded-lg mb-3 items-center">
					...
					<Flex.Column>
						<Heading numberOfLines={1}>{user.forename} {user.surname}</Heading>
						<Copy
							size="sm"
							color="yellow"
							className="-mt-1.5"
				...
				<Heading size="sm" className="mb-2">Forename</Heading>
				<TextField
				...
				/>
				<Heading size="sm" className="mt-5 mb-2">Surname</Heading>
				<TextField
				...
				/>
				<Heading size="sm" className="mt-5 mb-2">Email Address</Heading>
				<TextField
				...
				/>
				<Heading size="sm" className="mt-5 mb-2">Visibility</Heading>
				<ToggleCardButton
					classes="mb-2.5"
					title="Visible"
			...
			<Show if={errors}>
				<Flex className="items-center">
					<Copy color="chilli">Sorry we couldn't update you profile, please try again later.</Copy>
				</Flex>
			</Show>

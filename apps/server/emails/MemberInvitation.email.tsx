...
export const MemberInvitationEmail = (props: MemberInvitationEmailProps) => {
	...
	return (
		<EmailLayout
			ps={roles.includes("founder") && (
				<Section>
					<Copy marginTop={10} as="i">P.S Stay unruleh my friends xxx</Copy>
				</Section>
			)}
		>
			<Section>
			...
			<Section>
				<Copy marginBottom={10}>
					{!active ? "You have been invited to join" : "Your account has been created at"} <Link href="https://www.thechamomileclub.com">The Chamomile Club</Link> Please click below to {!active ? "accept your invitation" : "login into your account." }
				</Copy>
			</Section>
			<Section>
				...
				<Copy as="i" fontSize={12.5}>This link expires in 20 minutes</Copy>
			</Section>
		</EmailLayout>
	)
}

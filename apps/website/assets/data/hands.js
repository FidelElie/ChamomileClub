...
const hands = [
  {
    name: "High Card",
    description:
      "The lowest way to win, you have none of the other combinations, so the highest card wins (Ace is the highest card).",
  ...
  },
  {
    name: "Pair",
    description:
      "Very common, two cards of the same kind, for example you have one Ace in your hand and there's another on the table so you have a pair.",
  ...
  },
  {
    name: "Straight",
    description:
      "A series of five cards that follow eachother, they do not need to be of the same suit.",
  ...
  },
  {
    name: "Flush",
    description:
      "Five cards that are all of the same suit. These do not need to be in any particular order.",
  ...
  },
  {
    name: "Four of a Kind",
    description:
      "Low odds but high reward, you have four of the same kind. For example, four Aces!",
  ...
  },
  {
    name: "Straight Flush",
    description:
      "The second best hand, a combination of a flush and a straight, get this and watch out for lightening bolts.",
  ...
  },
  {
    name: "Royal Flush",
    description:
      "Go play the lottery, a straight flush from 10 to Ace, nothing beats this hand.",

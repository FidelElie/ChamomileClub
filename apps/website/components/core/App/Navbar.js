...
const Navbar = (props) => {
  ...
  return (
    <nav
      className={joinClasses("w-screen transition-colors", {
        "fixed z-20": fixed,
        ...
        <div className="flex items-center justify-between space-x-3">
          <AceSpades
            className={joinClasses(
              "w-min h-16 transform transition-transform shadow-lg rounded-md border border-transparent cursor-pointer hover:border-red-500",
              {

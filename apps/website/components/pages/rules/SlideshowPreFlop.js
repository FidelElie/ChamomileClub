...
const slides = [
  {
    ...
    title: "Steven - Hand",
    description:
      "Steven has pocket aces, with a hand like this they might consider raising the pot beyond the blind amount... Just to scare some people.",
  },
  {
    Cards: [TwoHearts, ThreeClubs],
    title: "Bobby - Hand",
    description:
      "Bobby has nothing particularly but there cards are in sequence. They want to wait for flop to see what the community holds.",
  },
  {

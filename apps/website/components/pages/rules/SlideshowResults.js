...
const slides = [
  ...
  },
  {
    ...
    description:
      "Steven has a Three of a Kind (three of the same card) with a Five of Diamonds and King of Diamonds as the highest cards to keep in hand. The Four of Spades and Three of Spades are both kicked.",
  },
  {
    Cards: [FiveDiamonds, FourSpades, ThreeClubs, TwoHearts, AceClubs],
    title: "Bobby: Strongest Hand",
    description:
      "Rearranging the community we see that Bobby definitely got the - Straight. Some hands beat others and a Straight is a better hand than a Three of a Kind - so Bobby wins and takes the pot.",
  },
  {
    Cards: [FiveDiamonds, KingDiamonds, KingHearts, TenSpades, AceClubs],
    title: "Seagal: Strongest Hand",
    description:
      "For completeness, let's also see Seagal's strongest hand. They ended up with a pair of Kings. So it was right of them to fold when they did. They were not winning this round.",
  },
];

...
export default function Home() {
  ...
  return (
    <AppLayout>
      ...
      <div
        className="py-20 px-8 mx-auto flex flex-col justify-center md:py-32 lg:py-52 container md:max-w-3xl text-center space-y-5 lg:max-w-6xl"
        ref={aboutSection}
      >
        <h2 className="text-secondary tracking-tight text-4xl font-medium font-heading mb-3 lg:mb-10 md:text-5xl lg:text-6xl">
      ...
      <div className="w-full py-20 shadow md:py-32 lg:py-52">
        <div className="mx-auto container flex flex-col px-8 items-center md:space-x-8 md:max-w-3xl md:px-12 md:flex-row lg:max-w-6xl">
          <div className="flex flex-col flex-grow mb-5 w-full md:w-1/2 md:mb-0">
            <span className="text-secondary text-4xl font-medium font-heading mb-2 md:text-5xl lg:text-6xl">
              Interested In The Movement?
            </span>
            <span className="text-2xl text-white tracking-tighter font-light">
              Sign up below to get the latest updates on{" "}

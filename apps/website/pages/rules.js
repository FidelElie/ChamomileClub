...
// ! Library
import { BlackChip, BlueChip, GreenChip, RedChip, WhiteChip } from "@chamomileclub/casinojs";
import { useTheme } from "../lib/providers/Theme.provider";

// ! Components
import AppLayout from "../components/core/App";
import { List, PageHeader, Paragraph, SubSubTitle, SubTitle } from "../components/core/Prose";
    ...
    <AppLayout title="The Chamomile Club | The Rules">
      <div className="w-full container max-w-4xl mx-auto px-8 pt-28 pb-10">
        ...
        <div ref={introReference}>
          ...
          <Paragraph>
            This page is for a poker player of any experience level to start with our{" "}
            <span className="text-2xl font-heading">Chamomile Club</span>{" "}
            poker nights. If you are familiar with how to play Texas Hold&apos;em from the beginning than feel free to
            skip to the House Additions section{" "}
            <ScrollLink onClick={() => scrollToReference(additionsReference)}>
              below
            </ScrollLink>
            . For those of you who are new, want clarification or to shake off the rust. Let&apos;s get started.
          </Paragraph>
        </div>
        <div ref={potsReference}>
          ...
          <Paragraph>
            A maximum number of ten players can be around the poker table and depending on if you would like to request
            to play for money or not two scenarios take place:
          </Paragraph>
          <div className="flex flex-col my-5 space-y-5">
            <List
              id="buy-in-1"
              items={[
                "A free buy in (not playing for money) can occur where an equal number of chips are allocated to each player with an agreed upon value for each. Our recommended values are displayed below for each of the chips we provide.",
              ]}
            />
            <div className="flex items-center justify-center space-x-5">
              {recommendedBase.map((base) => (
                ...
                >
                  ...
                  <span className="text-white font-semibold font-heading tracking-widest">
                    {base.value}
                  </span>
                </div>
              ))}
            ...
            <List
              id="buy-in-2"
              items={[
                "A buy in is agreed upon by players and held by the house, upon finishing the game, money is allocated to each player based on the proportion of chips they started with and now possess.",
              ]}
            />
          </div>
          <InformationBanner>
            <span className="uppercase font-medium">Note:</span>{" "}
            For all of the high-rollers out there. It is required that all players agree to a buy in for this scenario
            to take place on the night. Otherwise you are playing for free.
          </InformationBanner>
          <SubSubTitle>Stage One - The Pre-Flop</SubSubTitle>
          <Paragraph>
            After the chips are given out, it is time to play cards. The pot is where all the chips for that round go
            when bet by players. At the start of each round a player will have to put in a big blind, this is a
            compulsory amount of money that has to be at the start of each and every round. The player to their left is
            also required to place in their small blind - half of the big blind&apos;s value.
          </Paragraph>
          <Paragraph>
            We then go clockwise round the table and ask each person for their choice, Call Raise or Fold. This is three
            out of the four actions a player can do (other than the secret 5th - flipping the table). Let&apos;s see
            what they mean:
          </Paragraph>
          ...
          <InformationBanner>
            <span className="uppercase font-medium">Tip:</span>{" "}
            You haven&apos;t seen the cards in the community during the Pre Flop stage so its really hard to know if you
            have the winning hand at this point. Consider waiting for The Flop and not folding at this point -
            especially if you played the blind.
          </InformationBanner>
          <Paragraph>
            Once everyone has called the highest bet or folded, the next part begins. Let&apos;s look at an example:
            Steven, Bobby And Seagal are playing a round...
          </Paragraph>
          <div className="my-2">
            <SlideshowPreFlop />
          </div>
          <InformationBanner>
            <span className="uppercase font-medium">Note:</span>{" "}
            Knowing the hands is a great step towards winning rounds and chips. Check out each of the hands{" "}
            <Link href="/hands" className="underline">
              here
            </Link>
            .
          </InformationBanner>
          ...
          <Paragraph>
            The dealer will now start placing community cards - those of which are shared between players located in the
            middle of the table. In this round they place three cards called{" "}
            <span className="italic">&quot;The Flop&quot;</span>. Starting from the last person who raised on the table
            and still moving clockwise. This player has three possible actions they can do. They can Raise the bet, Fold
            or introducing the last action - Check.
          </Paragraph>
          <div className="flex flex-col my-5">
            <List
              id="flop-list"
          ...
          <Paragraph>
            We then go around the table, if that player raised everyone has to <span className="italic">Call</span>,
            {" "}
            <span className="italic">Raise</span> or <span className="italic">Fold</span>. If that player{" "}
            <span className="italic">Checks</span>{" "}
            then all other players are welome to follow suit. When everyone has called or checked this is the end of the
            round.
          </Paragraph>
          <div className="my-3">
            <SlideshowFlop />
          ...
          <Paragraph>
            Two more stages follow the second. The dealer places another card in the community for each.{" "}
            <span className="italic">&quot;The Turn&quot;</span> in the third stage and the{" "}
            <span className="italic">&quot;The River&quot;</span>{" "}
            in the fourth. Each of these rounds follow the same structure as the second. In the final when all betting
            has been done it is time for players to reveal their cards.
          </Paragraph>
          <InformationBanner>
            <span className="uppercase font-medium">Tip:</span>{" "}
            Know when to hold them and when to fold them. Staying in to The Turn and The River stages may have you
            putting in a lot of chips to stay in the round. Make sure you know its worth it. Its not the end of the
            world to fold and live to fight another round.
          </InformationBanner>
          <div className="my-8">
            <SlideshowTurnRiver />
          </div>
          <SubSubTitle topMargin>Who Dares Wins</SubSubTitle>
          <Paragraph>
            Your goal is to make the strongest five card hand possible with the cards in the community and those in your
            hand. Whoever has the strongest hand wins all the money in the pot. As simple as that, then the deck is
            reshuffled, the winner takes their chips and another round begins.
          </Paragraph>
          <div className="my-8">
            <SlideshowResults />
          </div>
        ...
        <div ref={additionsReference}>
          ...
          <Paragraph>
            Now that you know the basic rules and are clear on some exceptions. We can get to the good stuff and teach
            you the Founder&apos;s house rules.
          </Paragraph>
          <List
          ...
          <InformationBanner>
            <span className="uppercase font-medium">Note:</span>{" "}
            Don&apos;t worry about this rule if it&apos;s your first time. We will introduce it when you&apos;re ready.
          </InformationBanner>
          <List

...
export default function Rules() {
  return (
    <AppLayout title="The Chamomile Club | The Rules" navbarFixed>
      <div className="w-full container max-w-4xl mx-auto px-8 pt-28 pb-10 md:px-0">
        ...
        <Paragraph>
          This page is for a poker player of any experience level to start with our Poker Nights. If you are familiar with how to play Texas Hold'em from the beginning than feel free to skip to the Additions section below. For those of you who are new, want clarification or to free yourselves from the rust. Let's get started
        </Paragraph>
        ...
        <div className="flex flex-col my-5 space-y-5">
          <span className="text-white font-light">
            1. A free buy in (not playing for money) an equal number of chips are allocated to each player with an agreed upon value for each. Our recommended values are displayed below for each of the chips we provide.
          </span>
          ...
          <span className="text-white font-light">
            2. A buy in is agreed upon by players and held by the house, upon finishing the game, money is allocated to each player based on proportional.
          </span>
        </div>
        <SubSubTitle>First Round (Pre-flop)</SubSubTitle>
        <Paragraph>
          After the chips are given out, it is time to play cards. The pot is where all the chips that are bet for that round go. At the start of each round a player will have to put in a big blind, this is a compulosry amount of money tht has to be at the start of each and every round. The player to their left is also required to place in their small blind - half of the big blind's value (More on this later).
        </Paragraph>
        <Paragraph>
        ...
        <div className="flex flex-col my-5 space-y-5">
          ...
          <span className="text-white font-light">
            If a player <span className="italic">Folds</span>, you discard your cards and you are out of that round. Better hope it was worth it, there always the chance you may have won if you stayed in.
          </span>
        </div>
        <Paragraph>
          Once everyone has called the highest bet or folded, the next round begins.
        </Paragraph>
        <SubSubTitle topMargin>Second Round (The Flop)</SubSubTitle>
        <Paragraph>
        ...
        <div className="flex flex-col my-5 space-y-5">
          <span className="text-white font-light">
            If a player <span className="italic">Checks</span>, they are content with the state of the game do not want to raise or fold. As they are already at the maximum bet.
          </span>
        </div>
        <Paragraph>
          We then go around the table, if that player raised everyone has to call, raise or fold. If that player Checks then all other player are welome to follow suit. When everyone has called or checked this is the end of the round.
        </Paragraph>
        <SubSubTitle topMargin>
         Final Rounds<br className="md:hidden"/> (The Turn and The River)
        </SubSubTitle>
        <Paragraph>
            Two rounds follow the second where the dealer places another card in the community for each. <span className="italic">"The Turn"</span> in the third round and the <span className="italic">"The River"</span> in the fourth. Each of these rounds follow the same structure as the second. In the final when all betting has been done it is time for the players to reveal their cards.
        </Paragraph>
        <Paragraph>
          Your goal is to make the strongest five card hand you can with cards in the community and those in your hand. This is shown more clearly below and to have a look at the hands.
        </Paragraph>
        <div className="game">
            {/* TODO add game examples here */}
        </div>
        <Paragraph>
          Whoever has the strongest hand wins all the money in the pot. As simple as that, their are exceptions but those will be covered in the next sections. Then the deck is reshuffled and we repeat.
        </Paragraph>
        <SubTitle>House Additions</SubTitle>
        <Paragraph>Now that you know the basic rules and are clear on some exceptions. We can get to the good stuff and teach you the Founder's house rules.</Paragraph>
        <div className="flex flex-col my-5 space-y-5">
          <span className="text-white font-light">
